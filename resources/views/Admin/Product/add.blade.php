...
<body>
    <section class="min-h-screen p-6 bg-indigo-600 shadow-md dark:bg-gray-800">
        <h1 class="text-xl font-bold text-white capitalize dark:text-white">Add Product</h1>
        <form>
            <div class="grid grid-cols-1 gap-6 mt-4">
                <div>
                    <label class="text-white dark:text-gray-200" for="username">Series</label>
                ...
                <div>
                    <label class="text-white dark:text-gray-200" for="emailAddress">Storage</label>
                ...
                <div>
                    ...
                    <textarea id="textarea" type="textarea"
                        class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-pink-500 dark:focus:border-pink-500 focus:outline-none focus:ring"></textarea>
                </div>
                <div>
